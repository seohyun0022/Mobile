...
public class MapFragmentActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(v -> {
            ...
            if (query.isEmpty()) {
                Toast.makeText(MapFragmentActivity.this, "검색어를 입력해주세요.", Toast.LENGTH_SHORT).show();
            } else {
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            Toast.makeText(MapFragmentActivity.this, "현재 위치를 가져올 수 없습니다.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void getMyLocationAndSearch(String query) {
        ...
        fusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            Toast.makeText(MapFragmentActivity.this, "현재 위치를 가져올 수 없어 일반 검색을 시작합니다.", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(this, e -> {
                    ...
                    Toast.makeText(MapFragmentActivity.this, "위치 가져오기 실패. 일반 검색을 시작합니다.", Toast.LENGTH_SHORT).show();
    ...
    private void searchPlace(String query, LatLng coordinate) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                ...
                runOnUiThread(() -> Toast.makeText(MapFragmentActivity.this, "API 호출 실패: " + e.getMessage(), Toast.LENGTH_LONG).show());
            }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(() -> Toast.makeText(MapFragmentActivity.this, "API 응답 오류: " + response.code() + " - " + errorBody, Toast.LENGTH_LONG).show());
                }
            }
        });
    }
